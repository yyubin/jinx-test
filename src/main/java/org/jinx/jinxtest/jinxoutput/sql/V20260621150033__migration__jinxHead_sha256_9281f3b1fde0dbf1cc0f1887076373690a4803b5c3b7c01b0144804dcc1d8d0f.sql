...
-- jinx:head=sha256:9281f3b1fde0dbf1cc0f1887076373690a4803b5c3b7c01b0144804dcc1d8d0f
-- jinx:version=20260621150033
-- jinx:generated=2026-06-21T15:23:45.996988
...
CREATE TABLE "warehouse" (
  ...
  "used_capacity_sqm" DOUBLE PRECISION NOT NULL,
  ...
  "wh_city" VARCHAR(100),
  "active" BOOLEAN NOT NULL DEFAULT 'false',
  "total_capacity_sqm" DOUBLE PRECISION NOT NULL,
  PRIMARY KEY ("id"),
...
CREATE TABLE "coupon" (
  ...
  "premium_customer_only" BOOLEAN NOT NULL DEFAULT 'false',
...
CREATE TABLE "supplier" (
  ...
  "supplier_tier" VARCHAR(255) NOT NULL,
...
CREATE TABLE "manager" (
  ...
  "max_direct_reports" INTEGER NOT NULL,
...
CREATE TABLE "digital_product" (
  "digital_delivery_method" VARCHAR(255) NOT NULL,
  "id" BIGINT NOT NULL,
  "download_url" VARCHAR(200),
  "digital_has_drm" BOOLEAN NOT NULL DEFAULT 'false',
  "digital_max_downloads" INTEGER NOT NULL,
...
CREATE TABLE "electronics" (
  ...
  "smart_device" BOOLEAN NOT NULL DEFAULT 'false',
  "connectors" VARCHAR(300),
  "fragile" BOOLEAN NOT NULL DEFAULT 'false',
  "id" BIGINT NOT NULL,
  "voltage" INTEGER NOT NULL,
  "has_remote_control" BOOLEAN NOT NULL DEFAULT 'false',
...
CREATE TABLE "software_license" (
  ...
  "subscription_based" BOOLEAN NOT NULL DEFAULT 'false',
  "max_downloads" INTEGER NOT NULL,
  "file_formats" VARCHAR(200),
  "version" VARCHAR(50),
  "license_type" VARCHAR(255),
  "has_drm" BOOLEAN NOT NULL DEFAULT 'false',
  "supports_offline_mode" BOOLEAN NOT NULL DEFAULT 'false',
  "file_size_mb" DOUBLE PRECISION,
...
CREATE TABLE "downloadable_media" (
  ...
  "language" VARCHAR(10),
  "media_max_downloads" INTEGER NOT NULL,
  ...
  "isbn" VARCHAR(50),
  "file_size_mb" DOUBLE PRECISION,
  "media_has_drm" BOOLEAN NOT NULL DEFAULT 'false',
  "media_delivery_method" VARCHAR(255) NOT NULL,
  PRIMARY KEY ("id")
);
...
CREATE TABLE "premium_customer" (
  ...
  "id" BIGINT NOT NULL,
  "exclusive_discount_rate" NUMERIC(5,4) NOT NULL,
  "membership_end_date" DATE,
  "dedicated_manager_id" BIGINT,
  "premium_tier" VARCHAR(255) NOT NULL,
...
CREATE TABLE "crypto_payment" (
  ...
  "exchange_rate_at_payment" NUMERIC(20,8) NOT NULL,
  "id" BIGINT NOT NULL,
...
CREATE TABLE "credit_card_payment" (
  ...
  "three_ds_verified" BOOLEAN NOT NULL DEFAULT 'false',
